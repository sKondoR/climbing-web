  ...
  return (
    <div className="flex items-center justify-between max-w-[700px]">
      ...
      <div className="flex">
        ...
        <div className="ml-3">
          <input id={`is7${prefix}`} type="checkbox" checked={settings.is7} onChange={(e) => onChange(e, 'is7')} className="w-4 h-4 text-blue-500 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 focus:ring-2" />
