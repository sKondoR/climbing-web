    ...
    <div className="flex items-center mb-4">
      <div>
        <label className="inline-flex items-center cursor-pointer">
          <span className={`mr-2 text-sm font-medium ${settings.isLead ? 'text-gray-300' : 'text-gray-900'}`}>Боулдеринг</span>
          ...
          <span className={`ml-2 mr-2 text-sm font-medium ${settings.isLead ? 'text-gray-900' : 'text-gray-300'}`}>Трудность</span>
        </label>
      </div>
      <div className="ml-10">
        ...
        <label htmlFor={`is6${prefix}`} className="ms-2 text-sm font-medium text-gray-900">6a-6c</label>
      </div>
      <div className="ml-5">
        ...
        <label htmlFor={`is7${prefix}`} className="ms-2 text-sm font-medium text-gray-900">7a-7c</label>
      </div>
      <div className="ml-5">
        ...
        <label htmlFor={`is8${prefix}`} className="ms-2 text-sm font-medium text-gray-900">8a-8c</label>
      </div>
      {settings.isLead && (
        <div className="ml-10">
        ...
        <label htmlFor={`isTopRope${prefix}`} className="ms-2 text-sm font-medium text-gray-900">с верхней</label>
      </div>
      )}
    </div>
  );
