...
import { GetRouteImgBtn } from '../../../../5-features/getRouteImg/ui/GetRouteImgBtn';
      ...
      <div>
        ...
        {routes?.map((route: IRoute) => {
          ...
          return <div className="flex hover:bg-white/50 text-sm py-1" key={getRouteKey(route)}>
            ...
            <div className="grow"><GetRouteImgBtn route={route} /> {route.name} {route.isTopRope ? '(верхняя)' : ''}</div>
